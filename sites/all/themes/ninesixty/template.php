 ...
 */
function subninesixty_preprocess_html(&$vars) {
 ...
 */
function subninesixty_preprocess_page(&$vars, $hook) {
  ...
  if (isset($vars['node'])) {
    if ($vars['node']->type == 'gallery' && (is_numeric(arg(1)) && arg(1) === '60')) {
 ...
 */
function subninesixty_css_alter(&$css) {
